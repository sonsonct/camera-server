...
export class ProductsController {
  ...
  @Put('/sale/:id')
  @HttpCode(HttpStatus.OK)
  async updateProductSale(@Param('id') id: number, @Body() body: any) {
    return await this.productsService.updateSaleProduct(body, id);
  }
  ...
  @Get('')
  @HttpCode(HttpStatus.OK)
  async getListProduct(@Query() query: GetListProductDto) {
